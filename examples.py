...
def run_examples():
    # use timer (as a context manager) to get execution time
    with timer():
    ...
    # print table with self-adjusted column width
    ...
    # text block that enclose a snippet
    ...
    # get 3 key statistics of a list at once
